...
document.querySelectorAll('section, .project-card, .publication-card, .timeline-item, .skill-category').forEach(el => {
...
const revealElements = document.querySelectorAll('.timeline-item, .project-card, .publication-card');
